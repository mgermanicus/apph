...
public class DataBaseConfig {
    ...
    public void initialize() {
        ...
        em.persist(elieT2);
        //Photo
        Photo photo1 = new Photo().setFormat(".jpeg").setUser(alexandre).setSize(1200).addTag(elieT1).setTitle("photo").setDescription("photo test").setCreationDate(LocalDate.now()).setModificationDate(LocalDate.now()).setShootingDate(LocalDate.now()).setFolder(alexandreRoot);
        // NOTE : you need a file named 1.jpeg in your S3 folder with this photo in the database
        Photo photo2 = new Photo().setFormat(".png").setUser(alexandre).setSize(1300).addTag(elieT1).setTitle("photo2").setDescription("photo test 2").setCreationDate(LocalDate.parse("1970-01-02")).setModificationDate(LocalDate.parse("1970-01-02")).setShootingDate(LocalDate.now()).setFolder(alexandreRoot);
        ...
        Photo eliePhoto6 = new Photo().setUser(elie).setSize(1300).addTag(elieT2).setTitle("photo6").setDescription("photo test 6 dans root").setCreationDate(LocalDate.now()).setModificationDate(LocalDate.now()).setShootingDate(LocalDate.now()).setFolder(elieRoot);
        ...
        Photo eliePhoto11 = new Photo().setUser(elie).setSize(1300).addTag(elieT5).setTitle("photo11").setDescription("photo test 11 dans child 1").setCreationDate(LocalDate.now()).setModificationDate(LocalDate.now()).setShootingDate(LocalDate.now()).setFolder(elieChild1);
        Photo eliePhoto12 = new Photo().setUser(elie).setSize(1300).addTag(elieT6).setTitle("photo12").setDescription("photo test 12 dans child 1").setCreationDate(LocalDate.now()).setModificationDate(LocalDate.now()).setShootingDate(LocalDate.now()).setFolder(elieChild1);
