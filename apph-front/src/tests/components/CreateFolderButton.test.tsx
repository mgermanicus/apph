...
import {clickButton, fillText, triggerRequestFailure, triggerRequestSuccess} from "../utils/library";
import Cookies from "universal-cookie";
import jwtDecode from "jwt-decode";
import {JWS_TOKEN} from "../utils/token";

describe('Create Folder Button Tests', () => {
    let onSetRootFolder = jest.fn();
    beforeEach(() => {
        jest.clearAllMocks();
    });
    ...
    it('open with success the creation dialog', () => {
        //GIVEN
        render(<CreateFolderButton selected={"1"} setRootFolder={onSetRootFolder} />)
        //WHEN
